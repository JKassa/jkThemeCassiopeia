				...
				<div class="card over-wraper-long">
					...
					<div class="card-body p-2">
						...
						<div class="btn-group mt-2 w-100">
							<!--More-->
							<a href="{{ product.url }}" data-click="select-product" data-id="{{ product.id }}" class="btn btn-sm btn-outline-secondary" title="{{ 'sprintf' | jtext: 'COM_JKASSA_READ_MORE', product.name }}" target="_top">
		...
		<li class="col-12 col-sm-6 col-md-{{ col_md }}">
			<div class="over-wraper">
				<div class="card over-wraper-long crossblock">
					<a href="#" class="text-decoration-none" data-click="more-products" data-more="{{ moreProducts }}" data-limit="{{ selectedLimit }}">
						<div class="cross">
							<span>&#10227;</span>
						</div>
