						...
						<tbody>
							...
							<tr>
								<td class="linkbelow" style="padding: 7px 0">
									<font size="2" face="Open-sans, sans-serif" color="#555454">
										{{ 'sprintf' | jtext: 'FILES_JKTHEME_CASSIOPEIA_EMAIL_NEW_REVIEW_DESC', shop_name, product_url, 'color:#5e6981', product_name }}
									</font>
									<br>
									<br>
									<font size="2" face="Open-sans, sans-serif" color="#555454">
										<strong>{{ '_' | jtext: 'COM_JKASSA_REVIEWS_REVIEW' }}:</strong>
										<br>
										{{ review }}
									</font>
								</td>
