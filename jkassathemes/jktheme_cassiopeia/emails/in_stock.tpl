...
<title>{{ shop_name }} - {{ '_' | jtext: 'FILES_JKTHEME_CASSIOPEIA_EMAIL_IN_STOCK' }}</title>
<style>
						...
						<tbody>
							...
							<tr>
								<td class="linkbelow" style="padding: 7px 0">
									<font size="2" face="Open-sans, sans-serif" color="#555454">
										{{ 'sprintf' | jtext: 'FILES_JKTHEME_CASSIOPEIA_EMAIL_IN_STOCK_DESC', product_url, 'color:#5e6981', product_name }}
										{% if add_desc %}
										<br><br>
										{{ add_desc }}
										{% endif %}
