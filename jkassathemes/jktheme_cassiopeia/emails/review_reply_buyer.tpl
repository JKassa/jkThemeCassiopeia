...
<title>{{ shop_name }} - {{ '_' | jtext: 'FILES_JKTHEME_CASSIOPEIA_EMAIL_REPLY' }}</title>
<style>
						...
						<tbody>
								...
								<td class="titleblock" style="border-bottom: 1px solid #e2e7eb; padding: 7px 0" align="center">
									<font size="2" face="Open-sans, sans-serif" color="#555454">
										<span class="title" style="font-weight: 500; font-size: 28px; text-transform: uppercase; line-height: 33px">
											{{ 'sprintf' | jtext: 'FILES_JKTHEME_CASSIOPEIA_EMAIL_HELLO', user_recipient }}
										</span>
									</font>
								</td>
							</tr>
							...
							<tr>
								<td class="linkbelow" style="padding: 7px 0">
									<font size="2" face="Open-sans, sans-serif" color="#555454">
										{{ 'sprintf' | jtext: 'FILES_JKTHEME_CASSIOPEIA_EMAIL_REPLY_DESC', shop_name, product_url, product_name }}
									</font>
									<br>
									<br>
									<font size="2" face="Open-sans, sans-serif" color="#555454">
										<strong>{{ '_' | jtext: 'MESSAGE' }}:</strong>
										<br>
										{{ review }}
									</font>
								</td>
							...
							<tr>
								<td class="linkbelow" style="border-top: 1px solid #e2e7eb; padding: 7px 0">
									<font size="2" face="Open-sans, sans-serif" color="#555454">
										<em>* {{ 'sprintf' | jtext: 'FILES_JKTHEME_CASSIOPEIA_EMAIL_REVIEW_FOOTER', product_name, url_unsubscribe }}</em>
										<br>
