...
<title>{{ shop_name }} - {{ 'sprintf' | jtext: 'COM_JKASSA_REGISTRATION_TITLE', user_name }}</title>
<style>
								...
								<td class="titleblock" style="border-bottom: 1px solid #e2e7eb; padding: 7px 0" align="center">
									<font size="2" face="Open-sans, sans-serif" color="#555454">
										...
										<span class="subtitle" style="font-weight: 500; font-size: 16px; text-transform: uppercase; line-height: 25px">
											{{ 'sprintf' | jtext: 'COM_JKASSA_REGISTRATION_THANKS', shop_name }}
										</span>
									</font>
								</td>
							</tr>
												...
												<td style="padding: 7px 0">
													<font size="2" face="Open-sans, sans-serif" color="#555454">
														<p style="border-bottom: 1px solid #D6D4D4; margin: 3px 0 7px; text-transform: uppercase; font-weight: 500; font-size: 18px; padding-bottom: 10px" data-html-only="1">
															{{ '_' | jtext: 'COM_JKASSA_REGISTRATION_DETAILS' }}
														</p>
														<span style="color: #777; font-family: Open-sans,sans-serif; font-size: small">
															{{ 'sprintf' | jtext: 'COM_JKASSA_REGISTRATION_ADMIN_ACTIVATION_BODY', activate_url, shop_name, user_login, user_password }}
														</span>
													</font>
												</td>
												<td style="padding: 7px 0" width="10"></td>
												...
												<td style="padding: 7px 0">
													<font size="2" face="Open-sans, sans-serif" color="#555454">
														<p style="border-bottom: 1px solid #D6D4D4; margin: 3px 0 7px; text-transform: uppercase; font-weight: 500; font-size: 18px; padding-bottom: 10px">
															{{ '_' | jtext: 'FILES_JKTHEME_CASSIOPEIA_EMAIL_SAFETY_TIPS_TITLE' }}
														</p>
														<ol style="margin-bottom: 0">
															{{ '_' | jtext: 'FILES_JKTHEME_CASSIOPEIA_EMAIL_SAFETY_TIPS_DESC' }}
														</ol>
													</font>
												</td>
												<td width="10" style="padding:7px 0">&nbsp;</td>
