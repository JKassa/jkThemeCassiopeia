...
<title>{{ shop_name }} - {{ '_' | jtext: 'FILES_JKTHEME_CASSIOPEIA_EMAIL_COUPON' }}</title>
<style>
											...
											<td style="padding: 7px 0">
												<font size="2" face="Open-sans, sans-serif" color="#555454">
													<p style="border-bottom: 1px solid #D6D4D4; margin: 3px 0 7px; text-transform: uppercase; font-weight: 500; font-size: 18px; padding-bottom: 10px" data-html-only="1">
														{{ '_' | jtext: 'FILES_JKTHEME_CASSIOPEIA_EMAIL_COUPON_TITLE' }}
													</p>
													{% if add_desc %}
													<p style="color:#777">{{ add_desc }}</p>
													{% endif %}
													<p style="color:#777">
														{{ 'sprintf' | jtext: 'FILES_JKTHEME_CASSIOPEIA_EMAIL_COUPON_DESC', coupon_code }}
													</p>
												</font>
											</td>
											<td width="10" style="padding:7px 0">&nbsp;</td>
